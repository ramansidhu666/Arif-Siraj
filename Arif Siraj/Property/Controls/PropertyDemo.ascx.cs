        ...
        void GetPropertyDetails()
        {
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    lblwalk.PostBackUrl = "http://www.walkscore.com/score/loc/lat=" + lat + "/lng=" + lng + "/?utm_source=http:/http://arifsirajproperty.ca&amp;utm_medium=ws_api&amp;utm_campaign=ws_api";
                }
                Response.Write(sb);
