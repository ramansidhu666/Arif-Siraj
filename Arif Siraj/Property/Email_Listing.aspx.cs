    ...
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>Arif Siraj for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                html.AppendLine("<h2 style='font-weight: bold; font-size: 16px;'>Message Received From:</h2>");
                html.AppendLine("<p style='float: left; margin: 0 40px 0 0;'>Phone Number:</p><span style='float:left;'>416-832-1437</span><br/>");
                ...
                html.AppendLine("<p>www.arifsirajproperty.ca</p>");
                ...
                html.AppendLine("<p>For more information visit <a href='#'>www.arifsirajproperty.ca</a> </p></div>");
                html.AppendLine("<div style='float:left; padding-left:12px;'>");
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Arif Siraj<br/>Broker of record</p>");
                html.AppendLine(" <h2 style='font-size:16px;'>Leading Edge Realty Inc.</h2>");
                html.AppendLine("<p style='margin:0px;'>470 Chrysler Dr # 20, Brampton, L6S0C1</p>");
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Cell::</p><span style='float:left;'>647-297-0699</span><br/>'");
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>E-mail:</p><span style='float:left;'>arifsiraj71@hotmail.com</span><br/>");
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Website:</p><span style='float:left;'>www.arifsirajproperty.ca</span><br/></div></div>");
                html.AppendLine("<div style='float:left; width:100%;'>");
