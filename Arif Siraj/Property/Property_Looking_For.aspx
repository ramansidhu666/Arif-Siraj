        ...
        <div class="container">
            ...
            <div class="col-md-6">
                ...
                <div class="khlon_frm_bg">
                    <div class="row">
                        <asp:Label ID="label1" Text="Note: All * fields are mandatory" CssClass="labelmendatory" runat="server"></asp:Label>
                    </div>
                    ...
                    <fieldset class="login_input">
                       ...
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Email is Required"
                            ControlToValidate="txtEmail" ValidationGroup="SaveInfo" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                            ControlToValidate="txtEmail" ForeColor="Red" Display="Dynamic" ErrorMessage="Invalid email!" ValidationGroup="SaveRegInfo">  
                    ...
                    <fieldset class="login_input">
                        ...
                        <asp:RequiredFieldValidator ID="reqPhoneno" runat="server" ValidationGroup="SaveRegInfo" ErrorMessage="Phone Number is Required" ControlToValidate="txtPhoneno"
                    ...
                    <fieldset class="login_input">
                        <label for="exampleSelect2">Preferred Location</label>
